...
export function messagesReducer(
  ...
  switch (action.type) {
    case CHANGE_MESSAGE_TYPE:
      return state.set('messageType', action.payload)

    case CHANGE_MESSAGE_TEXT:
      return state.set('displayMessage', '').set('messageText', action.payload)

    case CHANGE_SHARED_STATUS:
      return state.set('displayMessage', '').set('sharedStatus', action.payload)
    ...
    case CLEAR_DISPLAY:
      return state.set('displayMessage', undefined)
